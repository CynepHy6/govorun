...
\`Здесь помогают только по ЛКУ, триггерам или вопросам, которые не относятся к списку ниже\`

*Проблемы с оплатой на вводном уроке*
<https://skyeng.slack.com/archives/CAT9LJ665|#tech-sup-methodists>

*Проблемы с работой сервиса подбора группы*
<https://skyeng.slack.com/archives/C01237HUVJ9|#schedule-qa-support>

*Проблемы с задачами Awake, Исходящей линии, Техподдержки, робозвонками*
<https://skyeng.slack.com/archives/CBD8J8LG3|#crm2-support>

*Начисление бонусов, перевод баланса и конвертация, консультация по экосистеме школы, перезвон ученику, проблема с оплатой/балансом, повторное подключение услуги*
Создайте соответствующий запрос в CRM2.
