...
Начисление бонусов, перевод баланса и конвертация, консультация по экосистеме школы, перезвон ученику, проблема с оплатой/балансом, повторное подключение услуги - создайте соответствующий запрос в CRM2.
